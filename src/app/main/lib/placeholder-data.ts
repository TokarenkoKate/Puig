import { SliderItem } from "@/components/custom/history-slider/history-slider";

export const historySliderItems: SliderItem[] = [
  {
    year: 1914,
...
export const mainPageImagesGallery = [
  {
