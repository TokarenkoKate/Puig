...
export const banderasPerfumeDetails: PerfumeDetails[] = [
    ...
    description: [
      {
        ...
        heading: "Непревзойдённый аромат The ICON",
        id: 1,
      },
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Глубокий аромат, который раскрывает сильные стороны его обладателя. Стильный, надежный, мужественный и стойкий. Цвет чёрного графита, в котором выполнен новый флакон, передает глубокие и насыщенные грани аромата. В центре флакона — монета, которая символизирует успех как стиль жизни.",
        ],
        id: 2,
      },
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/Y1uONv7csz8",
        id: 3,
      },
      {
        type: ContentBlockType.HEADING,
        heading: "Формула успеха",
        id: 4,
      },
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "The Icon The Perfume — первая парфюмерная вода от бренда Banderas, которая постепенно раскрывает свои грани. Так же, как и его обладатель — мужчина, который знает свои сильные стороны и применяет их в нужный момент. С самого начала аромат очаровывает первыми аккордами грейпфрута, можжевельника и черного перца. Затем в игру вступают глубокие ноты лаванды, кипариса, ириса и замши. Завершающие ноты станут поистине незабываемыми: маскулинное сочетание пачули, ветивера, лабданума и бензоина. The Icon The Perfume — аромат, который воплощает в себе секрет успеха.",
        ],
        id: 5,
      },
    ],
    ...
    description: [
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Что такое успех? Это слава? Власть? Удача?",
          "Возможно, это всегда было связано именно с этими понятиями, но времена меняются. Пришло время переопределить и трансформировать значение успеха, подойдя к нему с женской и актуальной точки зрения.",
          "Новая парфюмерная вода The Icon for women воплощает в себе новые концепции. Можем ли мы быть нежными и полными сил одновременно?",
          "Это основная идея аромата, который избегает очевидного и движется к тонким территориям, где вы можете быть смелыми и свободными: точно так же, как женщина, которую он представляет.",
          "Успех – это отношение. Мужество, свобода, энтузиазм и подлинность — новые ценности, которые сейчас на подъеме.",
          "Женщина Icon улыбается жизни и борется за то, чего она хочет. Ее девиз: будь уверенной, свободной, смелой, восторженной, оригинальной, подлинной и естественной.",
          "Композиция состоит из живых, игривых и ярких нот. Бергамот, черная смородина, мандарина, а также грушевый сок составляют пикантный и сочный старт. В сердце раскрывается богатый цветочный букет из цветков апельсина, фрезии, жасмина, розы и лаванды. Мягкая база аромата состоит из сливочной ванили, сандалового дерева, бобов тонка и мускусов.",
        ],
        id: 1,
      },
      {
    ...
    description: [
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Banderas представляет самую насыщенную парфюмерную воду The Icon Supreme, истинное воплощение триумфа. На этой высоте успех — больше, чем достижение, это особая энергия, пронизывающая каждую клеточку тела.",
          "Антонио Бандерас и Марио Касас вновь объединились в качестве дуэта, чтобы представить новый аромат The Icon Supreme. От больших экранов до парфюмерных премьер Banderas, их дороги не раз пересекались. Опыт каждого из них — это уникальная история успеха на стыке таланта, упорства и кропотливого труда.",
        ],
        id: 1,
      },
      {
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/QNz8gW8HshA",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
    ...
    description: [
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Победителем в игре соблазнения становится тот, кто готов рискнуть всем. Настоящий обольститель знает правила и никогда не позволит страху встать на его пути. Скорость, риск и адреналин ― в его ДНК. Он ― герой, которого манит опасность во всех ее проявлениях... Особенно, если речь идет о женщине.",
          "Power of Seduction представляет нового Антонио Бандераса, смелого и дерзкого. Свежий и энергичный мужской парфюм пробуждает желание бросить себе вызов, проявить смелость, преодолеть любые препятствия, встречающиеся на пути. Он опьяняет энергией соблазнения.",
        ],
        id: 1,
      },
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/sPdND3kZuhU",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Power of Seduction раскрывается свежими фруктовыми нотами бергамота и яблока. Лаванда и шалфей в сердце композиции наполняют аромат энергией авантюризма. Легкие восточные аккорды в базовых нотах контрастируют со свежестью мха и отражают истинно мужской характер. Оригинальный, изысканный и притягательный парфюм, с которым можно выйти победителем в любой игре.",
          "Элегантный матовый флакон Power of Seduction серебряно-металлического цвета в смелом сочетании с ярко-красным основанием делает его уникальным и привлекательным. Спортивный стиль и динамичный характер героя аромата находят воплощение в контрасте лаконичных линий флакона и колпачка, выполненной из черного каучука.",
          "Внешняя упаковка повторяет дизайн флакона: насыщенный красный цвет выделяется на белом и сером стальном фоне. Название аромата на этикетке сопровождается двумя скрещенными флагами ― фирменным логотипом Антонио Бандераса и одновременно символом, который ассоциируется со скоростью и жаждой адреналина.",
        ],
        id: 3,
      },
    ],
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/Cq29AMMavHM",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/JqjbeW1Ft7I",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Queen of Seduction ― женский аромат, который составит пару несравненному King of Seduction. Элегантный и чувственный аромат вдохновлен силой очарования и создан для искушенной и яркой женщины. Идеальная пара для King of Seduction. Флакон сразу притягивает взгляд своими элегантными, напоминающими драгоценный камень линиями. Цвет морской волны придает дизайну Queen of Seduction еще больше свежести, золотой колпачок подчеркивает утонченную женственность аромата.",
          "Волна водной, почти прозрачной, свежести усиливается звучанием искрящихся, ярких нот грейпфрута и сочной малины.",
          "Утонченные цветочные ноты ириса, жасмина и пионов в сердце аромата возглавляют цветочную композицию Queen of Seduction.",
          "Подчеркнуто женственный, цветочный букет окутан мягкими нотами розового перца, что придает аромату еще больше чувственности и очарования.",
          "Необычный, в то же время простой и элегантный аккорд замши контрастирует с притягательными полутонами амбры и характерными нотами кедрового дерева в базе аромата, завершая соблазнительную композицию Queen of Seduction.",
        ],
        id: 3,
      },
    ],
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/TofyqOm0Gpo",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/L0WlzedBedI",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/6me7lgqBFRI",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/xUTHslsQBMo",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/KGmiYs7F9F8",
        id: 4,
      },
      {
        type: ContentBlockType.TEXT,
    ...
    description: [
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "АБСОЛЮТНАЯ ФОРМА ОБОЛЬЩЕНИЯ",
          "Случайная встреча. Мимолётное прикосновение. Мгновение, сила которого будет длиться вечно, заставляя желать большего. Вы будете бесконечно искать его заново, пытаясь воссоздать этот неповторимый момент.",
          "Banderas представляет самую насыщенную ольфакторную композицию в коллекции The Secret — парные ароматы Secret Absolu. Этот дуэт — воплощение нового парфюмерного, по-настоящему премиального подхода. Настолько интенсивный, что одна капля обеспечивает длительное ощущение абсолютного соблазнения.",
          "ТАЙНА ОБРЕТАЕТ НОВУЮ ГЛУБИНУ",
          "Эти исключительные ароматы в новой концентрации парфюмерной воды открывают новую, самую драматичную главу в истории The Secret. Искусно созданные для мужчин и женщин, эти ароматы хранят в себе ключ к обольщению — и тот, кто владеет им, знает силу его притяжения. Этот самый роскошный и премиальный запуск Banderas — воплощение истинной сущности The Secret.",
        ],
        id: 1,
      },
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/-7fum-hfOPw",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
  ...
  },
  {
    ...
    description: [
      ...
      {
        type: ContentBlockType.VIDEO,
        src: "https://www.youtube.com/embed/Sag5MXpqw8A",
        id: 2,
      },
      {
        type: ContentBlockType.TEXT,
        paragraphs: [
          "Элегантная атмосфера. Вечерние коктейли. Приглушённый свет. Изысканный дуэт коньяка и замши окутывают пряные ароматические ноты. Его безупречную харизму усиливает едва уловимый аккорд шафрана, создавая современное и неповторимое звучание.",
        ],
        id: 3,
      },
    ],
