...
export const christianlouboutinPerfumeUniverses: PerfumeUniverse[] = [
  {
    ...
    subtitle: "5 ароматов",
    citation:
      "«У меня очень кокетливые отношения с FETICHE, и я осознаю, что моя работа, это и есть мой FETICHE»",
    content: [
      {
        text: "Christian Louboutin",
      },
      {
        text: "Спустя 10 лет после запуска LA LAQUE — символа бренда Christian Louboutin, мы с радостью знакомим Вас с новой коллекцией ароматов. Дизайн флаконов был вдохновлен знаковым силуэтом, культового флакона лака для ногтей. Флакон из увесистого стекла, с колпачком в форме культовой, узнаваемой шпильки.",
      },
      {
        text: "Провокационное называние коллекции Fétiche и при этом абсолютно понятные названия ароматов, предлагают удивительно неожиданные джусы.",
      },
      {
        text: "Какой Fétiche ТВОЙ?",
      },
    ],
    images: [
      {
  ...
  },
  {
    ...
    content: [
      {
        text: "Каждая парфюмерная композиция в коллекции LOUBIWORLD таит в себе личную историю, воспоминания и мечты ее создателя о путешествиях по миру.",
      },
      {
        text: "Кристиан Лубутен с детства проявлял неуемный интерес к людям и культурам всего мира. Легендарные путешествия дизайнера обуви подпитывают его творческий потенциал, и известно, что он находит вдохновение в самых отдаленных уголках земного шара!",
      },
    ],
    images: [
      {
