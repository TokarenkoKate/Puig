...
export const jeanpaulgaultierPerfumeUniverses: PerfumeUniverse[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { text: "Он одел Мадонну в конусообразный бюстгальтер! Скандал!" },
      { text: "Он привел моделей с улиц для своих показов! Скандал!" },
      { text: "Он первым отверг гендерные границы! Скандал!" },
      {
        text: "Он назвал коллекцию весна/лето 1988 «Консьерж на лестнице»! Скандал!",
      },
      { text: "Он всегда находил «политически корректное» скучным." },
      { text: "Жан-Поль Готье был первым кто знал, как создать...Скандал." },
      { text: "И только он мог создать...Scandal!" },
    ],
    images: [
      {
        id: 1,
...
export const jeanpaulgaultierBrandContent: BrandContentType = {
  ...
  bioSection: {
    ...
    videoSrc: "/assets/video/brands/jeanpaulgaultier/bio.mp4",
    paragraphs: [
