  ...
  bioSection: {
    content: {
      ...
      hidden: [
        ...
        {
          text: "С августа 2018 года должность креативного директора впервые в истории Nina Ricci разделили два человека ― Лиси Херребрюг и Рушеми Боттер из экспериментальной марки мужской одежды Botter. Их приход ознаменовал новую веху в развитии бренда ― дуэт привнес в его стиль каплю иронии и игривости.",
        },
        {
          text: "В сентябре 2022 года на пост креативного директора назначен Харрис Рид. Харрис Рид настолько дитя соцсетей, что устроил для своей первой коллекции Nina Ricci самый настоящий прогрев. Его первое платье, созданное во французском ателье, мы увидели уже в декабре 2022-го — на Адель. На этом Рид не остановился, в конце концов, дружба со звездами и умение создавать инфоповоды — его главные козыри.",
        },
        {
          text: "Кутюр Nina Ricci и правда вдохновил Харриса Рида больше, чем все остальное. Дизайнер выделил жирным шрифтом кутюрные коды Nina Ricci. Огромные цветы-чокеры, пышные платья, начиненные перьями и тюлем, банты, максимально приталенный силуэт в платьях и костюмах, вертикальная полоска, горох и, конечно же, шляпы — все это напоминает, какой был Nina Ricci в 1980-е и 1990-е.",
        },
      ],
    },
